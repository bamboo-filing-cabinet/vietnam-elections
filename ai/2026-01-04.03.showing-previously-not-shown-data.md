...
## Initial Prompt
do an audit of data that is currently not being show on the site, some fields may not need to be shown. use ai/SCRATCHPAD.md to keep notes, track what needs to be changed and what has been track, open questions, decisions, and plan in milestones if needed on what to be changed. Remember to ask for my answers to open questions, and also my approval first before moving from one milestone to another.
